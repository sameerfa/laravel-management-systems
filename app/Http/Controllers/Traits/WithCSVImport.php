...
trait WithCSVImport
{
    ...
    private bool $modelIsTenantable = false;
    ...
    public function csvUpdate(Request $request)
    {
        $this->csvImportModel    = new $this->csvImportModel();
        $this->csvHasHeader      = (bool) $request->input('has_header');
        $this->modelIsTenantable = in_array('App\Traits\Tenantable', class_uses($this->csvImportModel), true);
